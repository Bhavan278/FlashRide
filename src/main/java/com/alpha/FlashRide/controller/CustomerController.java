...
public class CustomerController {
	...
	public ResponseStructure<AvailableVehiclesDTO> availableVehicles(@RequestParam long mobileNo,
	...
	public ResponseEntity<CustomerCancelBookingResponseDTO> cancelBooking(@RequestParam("bookingid") int bookingId,
			@RequestParam("custid") int customerId) {

		return ResponseEntity.ok(customerservice.cancelBookingByCustomer(customerId, bookingId));
	}
}
